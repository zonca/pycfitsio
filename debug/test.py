...
#data = datatype()
doublenull = c_double(0.)
#_cfitsio.ffgcv(ptr, TDOUBLE, 1, 1, 1, 10, byref(doublenull), data.ctypes.data_as(POINTER(c_double)), byref(anynul), byref(status))
#_cfitsio.ffgcv(ptr, TDOUBLE, 1, 1, 1, 10, byref(doublenull), data.ctypes.data_as(POINTER(c_double)), byref(anynul), byref(status))
_cfitsio.ffgcv(ptr, TDOUBLE, c_int(1), c_longlong(1), c_longlong(1), c_longlong(10), byref(doublenull), data.ctypes.data_as(POINTER(c_double)), byref(anynul), byref(status))
